...
namespace MyJournal.ApiServices
{
    public class CustomMultipartFileStreamProvider : MultipartMemoryStreamProvider
    {
        ...
        //public TaskIDWithMultipartFileStreamProvider(string dest)
        //{
        //    PayloadContent = new List<TaskPayloadContent>();
        //}
        ...
        //{
        //    TaskPayloadContent data = new TaskPayloadContent();
        //    foreach (var stream in Contents)
        //    {
        //        switch(stream.Headers.ContentDisposition.Name)
        //        {
        //            case "jobID":
        //                string jobID = await GetStringParam(stream);
        //                data.JobID = jobID;
        //                break;
        //            case "authenticationToken":
        //                string result = await GetStringParam(stream);
        //                data.AuthenticationToken = result;
        //                break;
        //        }

        //        //var parameters = stream.Headers.ContentDisposition.Parameters;
        //        //var data = new TaskPayloadContent
        //        //{
        //        //    AuthenticationToken = (GetNameHeaderValue(parameters, "authenticationToken")),
        //        //    JobID = GetNameHeaderValue(parameters, "jobID"),
        //        //};

        //        PayloadContent.Add(data);
        //    }
        ...
        private async Task<string> GetStringParam(HttpContent stream)
        {
            var fileBytes = await stream.ReadAsByteArrayAsync();
            string result = System.Text.Encoding.Default.GetString(fileBytes);
            return result;
        }
